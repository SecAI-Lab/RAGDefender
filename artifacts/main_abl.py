...
def main():
    ...
    for iter in range(args.repeat_times):
        ...
        for i in target_queries_idx:
            ...
            correct_ans = incorrect_answers[i]['correct answer']  # Get correct answer
            ...
            if args.use_truth == 'True':
                ...
                adv_path = f'{args.method}/{args.eval_dataset}/{args.eval_dataset}_{iter}_{iter_idx}.txt'
        ...
        accuracy_list.append(accuracy_cnt)  # Add accuracy count
